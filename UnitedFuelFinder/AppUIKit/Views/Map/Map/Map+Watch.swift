...
public struct UMap<AnnotationItems: RandomAccessCollection> where AnnotationItems.Element: Identifiable {
...
extension UMap where AnnotationItems == EmptyCollection<IdentifiableObject<NSObject>> {
