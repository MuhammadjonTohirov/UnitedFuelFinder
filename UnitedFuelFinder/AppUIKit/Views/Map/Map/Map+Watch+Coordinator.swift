...
extension UMap: WKInterfaceObjectRepresentable {
    ...
    public class Coordinator {
        ...
        func update(_ mapView: WKInterfaceMap, from newView: UMap, context: Context) {
            defer { view = newView }
        ...
        private func updateAnnotations(on mapView: WKInterfaceMap, from previousView: UMap?, to newView: UMap) {
        ...
        private func updateRegion(on mapView: WKInterfaceMap, from previousView: UMap?, to newView: UMap) {
        ...
        private func updateUserTracking(on mapView: WKInterfaceMap, from previousView: UMap?, to newView: UMap, animated: Bool) {
