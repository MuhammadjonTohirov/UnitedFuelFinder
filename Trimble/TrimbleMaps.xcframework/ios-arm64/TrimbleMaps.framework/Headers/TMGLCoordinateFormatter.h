...
/**
 The `TMGLCoordinateFormatter` class provides properly formatted descriptions of
 ...
 */
TMGL_EXPORT
@interface TMGLCoordinateFormatter : NSFormatter
...
/**
 This method is not supported for the `TMGLCoordinateFormatter` class.
 */
