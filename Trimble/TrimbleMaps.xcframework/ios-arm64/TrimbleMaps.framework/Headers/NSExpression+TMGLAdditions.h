...
@class TMGLAttributedExpression;

NS_ASSUME_NONNULL_BEGIN

typedef NSString *TMGLExpressionInterpolationMode NS_TYPED_ENUM;
...
/**
 ...
 expression operator in the TrimbleMaps Style Specification.
 */
FOUNDATION_EXTERN TMGL_EXPORT const TMGLExpressionInterpolationMode TMGLExpressionInterpolationModeLinear;
...
/**
 ...
 expression operator in the TrimbleMaps Style Specification.
 */
FOUNDATION_EXTERN TMGL_EXPORT const TMGLExpressionInterpolationMode TMGLExpressionInterpolationModeExponential;
...
/**
 ...
 expression operator in the TrimbleMaps Style Specification.
 */
FOUNDATION_EXTERN TMGL_EXPORT const TMGLExpressionInterpolationMode TMGLExpressionInterpolationModeCubicBezier;
...
/**
 ...
 <a href="https://www.mapbox.com/mapbox-gl-js/style-spec/#expressions">TrimbleMaps Style Specification</a>.
 */
@interface NSExpression (TMGLAdditions)
 ...
 */
+ (instancetype)tmgl_expressionForConditional:(nonnull NSPredicate *)conditionPredicate trueExpression:(nonnull NSExpression *)trueExpression falseExpresssion:(nonnull NSExpression *)falseExpression NS_SWIFT_NAME(init(forTMGLConditional:trueExpression:falseExpression:));
 ...
 */
+ (instancetype)tmgl_expressionForSteppingExpression:(nonnull NSExpression*)steppingExpression fromExpression:(nonnull NSExpression *)minimumExpression stops:(nonnull NSExpression*)stops NS_SWIFT_NAME(init(forTMGLStepping:from:stops:));
...
/**
 ...
 @param curveType The curve type could be `TMGLExpressionInterpolationModeLinear`,
 `TMGLExpressionInterpolationModeExponential` and
 `TMGLExpressionInterpolationModeCubicBezier`.
 ...
 Create a heatmap layer</a> example to learn how to style an `TMGLHeatmapStyleLayer`
 based on zoom level and point density with this expression.
 */
+ (instancetype)tmgl_expressionForInterpolatingExpression:(nonnull NSExpression*)inputExpression withCurveType:(nonnull TMGLExpressionInterpolationMode)curveType parameters:(nullable NSExpression *)parameters stops:(nonnull NSExpression*)stops NS_SWIFT_NAME(init(forTMGLInterpolating:curveType:parameters:stops:));
 ...
 */
+ (instancetype)tmgl_expressionForMatchingExpression:(nonnull NSExpression *)inputExpression inDictionary:(nonnull NSDictionary<NSExpression *, NSExpression *> *)matchedExpressions defaultExpression:(nonnull NSExpression *)defaultExpression NS_SWIFT_NAME(init(forTMGLMatchingKey:in:default:));

/**
 Returns an attributed function expression specifying an `TMGLAttributedExpression` constant
 expression array.
 
 @param attributedExpressions The `TMGLAttributedExpression` constant expression array.
 */
+ (instancetype)tmgl_expressionForAttributedExpressions:(nonnull NSArray<NSExpression *> *)attributedExpressions NS_SWIFT_NAME(init(forAttributedExpressions:));
 ...
 */
- (instancetype)tmgl_expressionByAppendingExpression:(nonnull NSExpression *)expression NS_SWIFT_NAME(tmgl_appending(_:));
 ...
 */
+ (instancetype)expressionWithTMGLJSONObject:(id)object NS_SWIFT_NAME(init(mglJSONObject:));
 ...
 */
- (NSExpression *)tmgl_expressionLocalizedIntoLocale:(nullable NSLocale *)locale;
