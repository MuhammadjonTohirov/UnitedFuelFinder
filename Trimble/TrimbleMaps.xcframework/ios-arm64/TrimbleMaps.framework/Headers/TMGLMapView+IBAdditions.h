...
@interface TMGLMapView (IBAdditions)
...
// inspectables declared in TMGLMapView.h are always sorted before those in
// TMGLMapView+IBAdditions.h, due to ASCII sort order.
