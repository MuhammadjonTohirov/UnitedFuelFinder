...
/**
 The `TMGLCompassDirectionFormatter` class provides properly formatted
 ...
 the user’s current location, use `TMGLClockDirectionFormatter` instead.
 */
TMGL_EXPORT
@interface TMGLCompassDirectionFormatter : NSFormatter
