...
#import "TrimbleMaps.h"
#import "TMGLCameraChangeReason.h"

NS_ASSUME_NONNULL_BEGIN

@class TMGLMapView;
@class TMGLUserLocationAnnotationViewStyle;

/**
 The `TMGLMapViewDelegate` protocol defines a set of optional methods that you
 can use to receive map-related update messages. Because many map operations
 require the `TMGLMapView` class to load data asynchronously, the map view calls
 ...
 */
@protocol TMGLMapViewDelegate <NSObject>
...
/**
 ...
 and `TMGLMapCamera` objects to restrict a users ability to pan your map.
 */
- (BOOL)mapView:(TMGLMapView *)mapView shouldChangeFromCamera:(TMGLMapCamera *)oldCamera toCamera:(TMGLMapCamera *)newCamera;
 ...
 */
- (BOOL)mapView:(TMGLMapView *)mapView shouldChangeFromCamera:(TMGLMapCamera *)oldCamera toCamera:(TMGLMapCamera *)newCamera reason:(TMGLCameraChangeReason)reason;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView regionWillChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView regionWillChangeWithReason:(TMGLCameraChangeReason)reason animated:(BOOL)animated;
...
/**
 ...
 as `-[TMGLMapView setCamera:animated:]`. This method can be called before
 ...
 */
- (void)mapViewRegionIsChanging:(TMGLMapView *)mapView;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView regionIsChangingWithReason:(TMGLCameraChangeReason)reason;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView regionDidChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView regionDidChangeWithReason:(TMGLCameraChangeReason)reason animated:(BOOL)animated;
 ...
 */
- (void)mapViewWillStartLoadingMap:(TMGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishLoadingMap:(TMGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFailLoadingMap:(TMGLMapView *)mapView withError:(NSError *)error;

// TODO
- (void)mapViewWillStartRenderingMap:(TMGLMapView *)mapView;

// TODO
- (void)mapViewDidFinishRenderingMap:(TMGLMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartRenderingFrame:(TMGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishRenderingFrame:(TMGLMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewDidBecomeIdle:(TMGLMapView *)mapView;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView didFinishLoadingStyle:(TMGLStyle *)style;

- (nullable UIImage *)mapView:(TMGLMapView *)mapView didFailToLoadImage:(NSString *)imageName;
...
/**
 ...
 the cached image.
 */
- (BOOL)mapView:(TMGLMapView *)mapView shouldRemoveStyleImage:(NSString *)imageName;
 ...
 */
- (void)mapViewWillStartLocatingUser:(TMGLMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (void)mapViewDidStopLocatingUser:(TMGLMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (TMGLUserLocationAnnotationViewStyle *)mapViewStyleForDefaultUserLocationAnnotationView:(TMGLMapView *)mapView NS_SWIFT_NAME(mapView(styleForDefaultUserLocationAnnotationView:));
...
/**
 ...
 `TMGLUserTrackingModeFollowWithHeading` and the heading changes, or if it is set
 to `TMGLUserTrackingModeFollowWithCourse` and the course changes.
 ...
 */
- (void)mapView:(TMGLMapView *)mapView didUpdateUserLocation:(nullable TMGLUserLocation *)userLocation;
...
/**
 ...
 @param error An error object containing the reason why location tracking
    failed.
 */
- (void)mapView:(TMGLMapView *)mapView didFailToLocateUserWithError:(NSError *)error;
...
/**
 ...
 @param animated Whether the change caused an animated effect on the map.
 */
- (void)mapView:(TMGLMapView *)mapView didChangeUserTrackingMode:(TMGLUserTrackingMode)mode animated:(BOOL)animated;
...
/**
 ...
 This method will override any values set by `TMGLMapView.userLocationVerticalAlignment`
 or `-[TMGLMapView setUserLocationVerticalAlignment:animated:]`.

 @param mapView The map view that is tracking the user's location.
 */
- (CGPoint)mapViewUserLocationAnchorPoint:(TMGLMapView *)mapView;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView didChangeLocationManagerAuthorization:(id<TMGLLocationManager>)manager API_AVAILABLE(ios(14));
...
/**
 ...
 image should be used for `TMGLAnnotation` objects that have been added to
 your map.
 */
- (nullable TMGLAnnotationImage *)mapView:(TMGLMapView *)mapView imageForAnnotation:(id <TMGLAnnotation>)annotation;
 ...
 */
- (CGFloat)mapView:(TMGLMapView *)mapView alphaForShapeAnnotation:(TMGLShape *)annotation;
...
/**
 ...
 `TMGLShape` object that has been added to your map as an annotation.
 */
- (UIColor *)mapView:(TMGLMapView *)mapView strokeColorForShapeAnnotation:(TMGLShape *)annotation;
...
/**
 ...
 `TMGLPolygon` at runtime.
 */
- (UIColor *)mapView:(TMGLMapView *)mapView fillColorForPolygonAnnotation:(TMGLPolygon *)annotation;
...
/**
 ...
 line width of an `TMGLPolylineFeature` on your map.
 */
- (CGFloat)mapView:(TMGLMapView *)mapView lineWidthForPolylineAnnotation:(TMGLPolyline *)annotation;
...
/**
 ...
 `annotation` is an instance of `TMGLUserLocation` (or equal to the map view’s
 `userLocation` property), return an instance of `TMGLUserLocationAnnotationView`
 ...
 `TMGLViewAnnotation` to use for a given `TMGLPointAnnotation` object on your
 map.
 */
- (nullable TMGLAnnotationView *)mapView:(TMGLMapView *)mapView viewForAnnotation:(id <TMGLAnnotation>)annotation;
...
/**
 ...
 @param annotationViews An array of `TMGLAnnotationView` objects representing the
    views that were added.
 */
- (void)mapView:(TMGLMapView *)mapView didAddAnnotationViews:(NSArray<TMGLAnnotationView *> *)annotationViews;
 ...
 */
- (BOOL)mapView:(TMGLMapView *)mapView shapeAnnotationIsEnabled:(TMGLShape *)annotation;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView didSelectAnnotation:(id <TMGLAnnotation>)annotation;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView didDeselectAnnotation:(id <TMGLAnnotation>)annotation;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView didSelectAnnotationView:(TMGLAnnotationView *)annotationView;
 ...
 */
- (void)mapView:(TMGLMapView *)mapView didDeselectAnnotationView:(TMGLAnnotationView *)annotationView;
...
/**
 ...
 `TMGLAnnotation` objects.
 */
- (BOOL)mapView:(TMGLMapView *)mapView annotationCanShowCallout:(id <TMGLAnnotation>)annotation;
...
/**
 ...
 @param annotation The object representing the annotation.
 @return A view conforming to the `TMGLCalloutView` protocol, or `nil` to use the
 ...
 `TMGLAnnotation` object's `TMGLCalloutView`.
 */
- (nullable id <TMGLCalloutView>)mapView:(TMGLMapView *)mapView calloutViewForAnnotation:(id <TMGLAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(TMGLMapView *)mapView leftCalloutAccessoryViewForAnnotation:(id <TMGLAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(TMGLMapView *)mapView rightCalloutAccessoryViewForAnnotation:(id <TMGLAnnotation>)annotation;
...
/**
 ...
 custom accessory views using the `TMGLCalloutView` protocol’s
 ...
 */
- (void)mapView:(TMGLMapView *)mapView annotation:(id <TMGLAnnotation>)annotation calloutAccessoryControlTapped:(UIControl *)control;
...
/**
 ...
 `-[TMGLCalloutViewDelegate calloutViewTapped:]` method.
 ...
 action when an `TMGLAnnotation`s `TMGLCalloutView` is tapped.
 */
- (void)mapView:(TMGLMapView *)mapView tapOnCalloutForAnnotation:(id <TMGLAnnotation>)annotation;
