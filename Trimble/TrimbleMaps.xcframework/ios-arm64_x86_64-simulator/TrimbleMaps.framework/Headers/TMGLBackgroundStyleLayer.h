...
/**
 An `TMGLBackgroundStyleLayer` is a style layer that covers the entire map. Use a
 ...
 access it by getting the last item in the `TMGLStyle.layers` array.
 ...
 */
TMGL_EXPORT
@interface TMGLBackgroundStyleLayer : TMGLStyleLayer
...
*/
@property (nonatomic) TMGLTransition backgroundColorTransition;
...
*/
@property (nonatomic) TMGLTransition backgroundOpacityTransition;
...
*/
@property (nonatomic) TMGLTransition backgroundPatternTransition;
