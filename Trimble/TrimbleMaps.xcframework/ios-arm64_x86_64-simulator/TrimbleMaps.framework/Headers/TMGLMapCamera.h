...
/**
 An `TMGLMapCamera` object represents a viewpoint from which the user observes
 some point on an `TMGLMapView`.
 ...
 panning using `TMGLMapViewDelegate`'s
`-mapView:shouldChangeFromCamera:toCamera:` method.
 */
TMGL_EXPORT
@interface TMGLMapCamera : NSObject <NSSecureCoding, NSCopying>
...
/**
 ...
 @return A Boolean value indicating whether the two cameras are functionally
    equivalent.
 */
- (BOOL)isEqualToMapCamera:(TMGLMapCamera *)otherCamera;
