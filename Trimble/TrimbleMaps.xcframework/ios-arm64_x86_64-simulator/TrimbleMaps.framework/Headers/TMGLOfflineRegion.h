...
/**
 An object conforming to the `TMGLOfflineRegion` protocol determines which
 resources are required by an `TMGLOfflinePack` object.
 */
@protocol TMGLOfflineRegion <NSObject>
...
/**
 ...
 See `TMGLIdeographicFontFamilyName` setting. Also, for regions outside of
