...
/**
 The `TMGLClockDirectionFormatter` class provides properly formatted descriptions
 ...
 irrespective of the user’s orientation, use `TMGLCompassDirectionFormatter`
 instead.
 */
TMGL_EXPORT
@interface TMGLClockDirectionFormatter : NSFormatter
...
/**
 This method is not supported for the `TMGLDirectionFormatter` class.
 */
