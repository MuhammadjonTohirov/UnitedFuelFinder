...
/**
 The `TMGLAnnotationImage` class is responsible for presenting point-based
 ...
 as a marker using `TMGLAnnotationImage`. 
 */
TMGL_EXPORT
@interface TMGLAnnotationImage : NSObject <NSSecureCoding>
