...
/**
 The `TMGLOverlay` protocol defines a specific type of annotation that represents
 ...
 */
@protocol TMGLOverlay <TMGLAnnotation>
 ...
 */
@property (nonatomic, readonly) TMGLCoordinateBounds overlayBounds;
 ...
 */
- (BOOL)intersectsOverlayBounds:(TMGLCoordinateBounds)overlayBounds;
