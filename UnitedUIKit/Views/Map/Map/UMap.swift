...
public struct UMap<AnnotationItems: RandomAccessCollection, OverlayItems: RandomAccessCollection>
...
extension UMap where AnnotationItems == [IdentifiableObject<MKAnnotation>] {
...
extension UMap where OverlayItems == [IdentifiableObject<MKOverlay>] {
...
extension UMap where AnnotationItems == [IdentifiableObject<MKAnnotation>], OverlayItems == [IdentifiableObject<MKOverlay>] {
