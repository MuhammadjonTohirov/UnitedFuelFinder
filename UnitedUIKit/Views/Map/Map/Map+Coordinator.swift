...
extension UMap {
    ...
    public class Coordinator: NSObject, MKMapViewDelegate {
        ...
        func update(_ mapView: MKMapView, from newView: UMap, context: Context) {
            defer { view = newView }
        ...
        private func updateAnnotations(on mapView: MKMapView, from previousView: UMap?, to newView: UMap) {
        ...
        private func updateInformationVisibility(on mapView: MKMapView, from previousView: UMap?, to newView: UMap) {
        ...
        private func updateInteractionModes(on mapView: MKMapView, from previousView: UMap?, to newView: UMap) {
        ...
        private func updateOverlays(on mapView: MKMapView, from previousView: UMap?, to newView: UMap) {
        ...
        private func updatePointOfInterestFilter(on mapView: MKMapView, from previousView: UMap?, to newView: UMap) {
        ...
        private func updateRegion(on mapView: MKMapView, from previousView: UMap?, to newView: UMap, animated: Bool) {
        ...
        private func updateType(on mapView: MKMapView, from previousView: UMap?, to newView: UMap) {
            if previousView?.mapType != newView.mapType {
                mapView.mapType = newView.mapType
            }
        }

        private func updateUserTracking(on mapView: MKMapView, from previousView: UMap?, to newView: UMap) {
