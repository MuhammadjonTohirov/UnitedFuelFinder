 ...
 */
typedef NS_ENUM(NSUInteger, TMGLAttributionInfoStyle) {
    /**
     Specifies a short attribution info style.
     */
    TMGLAttributionInfoStyleShort = 1,
    /**
     Specifies a medium attribution info style.
     */
    TMGLAttributionInfoStyleMedium,
    /**
     Specifies a long attribution info style.
     */
    TMGLAttributionInfoStyleLong
};
 ...
 */
TMGL_EXPORT
@interface TMGLAttributionInfo : NSObject
...
/**
 ...
 @param zoomLevel The map’s zoom level. See the `TMGLMapView.zoomLevel` property
...
/**
 ...
 Example: If the `style` property is set to `TMGLAttributionInfoStyleShort` and the
 ...
 */
- (NSAttributedString *)titleWithStyle:(TMGLAttributionInfoStyle)style;
